...
const struct {
    ...
    {"cmd-request", ":/icons/black/tx_input"},
    {"cmd-reply", ":/icons/black/tx_output"},
    {"cmd-error", ":/icons/black/tx_output"},
    {"misc", ":/icons/black/tx_inout"},
    {NULL, NULL}
};
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the BuzzCoin RPC console.") + "<br>" +
