...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About BuzzCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>BuzzCoin</b> version", 0));
...
"Copyright \302\251 2014 The BuzzCoin developers", 0));
